...
import expo.modules.liveupdates.LiveActivityConfig
...
class NotificationManager(
    ...
    fun startForegroundService(state: LiveActivityState, config: LiveActivityConfig) {
    ...
    var lastConfig: LiveActivityConfig? = null

    fun updateNotification(state: LiveActivityState, config: LiveActivityConfig? = null) {
        if(config !== null) {
            lastConfig = config
        }

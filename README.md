...
- `subText` is displayed in the notification header area, but there is no guarantee where exactly it will be located, based on [Android documentation](<https://developer.android.com/reference/android/app/Notification.Builder#setSubText(java.lang.CharSequence)>).
